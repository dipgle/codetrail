...
const I18N = {
  en: {
    ...
    "about.dogfood.ai1": "— a sister project exploring blockchain consensus protocols. Codetrail tracks UCs/TCs/test_runs across all node binaries; the discipline that ai1 enforces in code is the same discipline Codetrail enforces in process.",
  ...
  vi: {
    ...
    "about.dogfood.ai1": "— dự án anh em khám phá giao thức consensus blockchain. Codetrail track UCs/TCs/test_runs trên mọi node binary; kỷ luật ai1 ép trong code chính là kỷ luật Codetrail ép trong process.",
