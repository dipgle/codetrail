...
const I18N = {
  en: {
    ...
    "terms.s6": "6. Contact",
    "terms.s6p": "Questions, complaints, or DMCA notices: trace.codetrail@gmail.com.",
    ...
    "priv.s5p": "Our lawful basis for processing your email (waitlist) is your consent (GDPR Art. 6(1)(a)); for paid-tier syncs it is contract performance (Art. 6(1)(b)); for security logs it is legitimate interest (Art. 6(1)(f)). You have the right to: access a copy of your data, rectify it, erase it, restrict processing, port it elsewhere, and object. CCPA users additionally have the right to opt out of any sale or share (we do neither). Email trace.codetrail@gmail.com — we respond within 30 days.",
  ...
  vi: {
    ...
    "terms.s6": "6. Liên hệ",
    "terms.s6p": "Câu hỏi, khiếu nại, hoặc DMCA: trace.codetrail@gmail.com.",
    ...
    "priv.s5p": "Cơ sở pháp lý xử lý email (waitlist) là sự đồng ý của bạn (GDPR Art. 6(1)(a)); sync Pro/Team là thực hiện hợp đồng (Art. 6(1)(b)); log bảo mật là lợi ích chính đáng (Art. 6(1)(f)). Bạn có quyền: truy cập bản sao data, sửa, xóa, hạn chế xử lý, port đi nơi khác, và phản đối. User CCPA thêm quyền opt-out khỏi việc bán/chia sẻ (chúng tôi không làm cả hai). Email trace.codetrail@gmail.com — chúng tôi trả lời trong 30 ngày.",
